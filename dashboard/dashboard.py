...
main_data_df = pd.read_csv("https://drive.google.com/uc?export=download&id=1sNBUFhaFtuFPAb82x92uWYKRdbi_hbqn", chunksize=10000)
main_data_df = pd.concat(main_data_df)
